...
allows you to input your copied results from puzzle games such as [Connections](https://www.nytimes.com/games/connections), [Strands](https://www.nytimes.com/games/strands), [Wordle](https://www.nytimes.com/games/wordle), and [Bracket City](https://www.theatlantic.com/games/bracket-city/) and have two spaces automatically added to the end of each line. This makes the lines appear "stacked" when sharing on platforms that use [Markdown](https://www.markdownguide.org/), such as [Reddit](https://www.reddit.com/) and [Lemmy](https://join-lemmy.org/).
...
- Although this tool was specifically designed for use with Connections, it is also compatible with other NYT and NYT-style games that share results through the clipboard, such as [Strands](https://www.nytimes.com/games/strands), [Wordle](https://www.nytimes.com/games/wordle), and [Bracket City](https://www.theatlantic.com/games/bracket-city/), due to the result format being similar.
